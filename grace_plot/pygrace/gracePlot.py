...
class gracePlot:
    ...
    def __init__(self,figsize=None,param_file=None, nogui=False):
        self.grace = grace_np.GraceProcess(fixedsize=figsize,param_file=param_file, nogui=nogui)
...
class graceGraph:
    ...
    def __init__(self, grace, gID):
        ...
        self._hold = 1       # Set _hold=1 to add datasets to a graph
    ...
    def plot(self, X, Y=None, dy=None, symbols=None, styles=None, legend=None):
